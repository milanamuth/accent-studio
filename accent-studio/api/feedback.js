...
function buildPrompt({ day, title, referenceText, weakSpots }) {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { audioBase64, mimeType, day, title, referenceText, weakSpots } = body;
    ...
    res.status(200).json(coerceFeedback(raw));
  } catch (err) {
